...
//
//    /**
//     * Creates an ObservableList of EmailFXData and populate it with sample values for the Inbox folder
//     * @return The ObservableList<EmailData>
//     */
//    public ObservableList<EmailFXData> getSampleInboxEmailData(){
//        LocalDateTime date = LocalDateTime.now();
//        ObservableList<EmailFXData> emails = FXCollections.observableArrayList();
//        emails.addAll(new EmailFXData(1, "alice12@hotmail.com", "Meeting", date), new EmailFXData(2, "bob3y7@gmail.com", "Project", date), new EmailFXData(3, "alice12@hotmail.com", "Meeting2", date));
//        return emails;
//    }
//    
//    /**
//     * Creates an ObservableList of EmailFXData and populate it with sample values for the Sent folder
//     * @return The ObservableList<EmailData>
//     */
//    public ObservableList<EmailFXData> getSampleSentEmailData(){
//        LocalDateTime date = LocalDateTime.now();
//        ObservableList<EmailFXData> emails = FXCollections.observableArrayList();
//        emails.addAll(new EmailFXData(4, mailBean.getEmailAddress(), "Breakfast", date), new EmailFXData(5, mailBean.getEmailAddress(), "Game Project", date), new EmailFXData(6, mailBean.getEmailAddress(), "Subject 3", date));
//        return emails;
//    }
//    
//    /**
//     * Creates an ObservableList of EmailFXData and populate it with sample values for the Draft folder
//     * @return The ObservableList<EmailData>
//     */
//    public ObservableList<EmailFXData> getSampleDraftEmailData(){
//        LocalDateTime date = LocalDateTime.now();
//        ObservableList<EmailFXData> emails = FXCollections.observableArrayList();
//        emails.addAll(new EmailFXData(7, mailBean.getEmailAddress(), "Draft 1", date), new EmailFXData(8, mailBean.getEmailAddress(), "Draft 2", date), new EmailFXData(9, mailBean.getEmailAddress(), "Draft 3", date));
//        return emails;
//    }
//    
